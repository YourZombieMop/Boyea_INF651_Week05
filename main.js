...
const question4 = (myNumber) => {
  ...
  /////// write your SWITCH statement below this line /////////
	// note: The question doesn't say the values are supposed to be Strings and it doesn't
	// have quotes around the variable names, but I'm going to assume they are supposed to
	// be strings (ex. myFaveFood = "Pizza"; NOT myFaveFood = Pizza;)
	// I'm assuming this because 'Ice Cream' has a space and I know variable identifiers
	// can't have spaces.
	switch(myNumber) {
		case 1:
			myFaveFood = "Pizza";
